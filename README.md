...
Аптымальныя параметры аўдыяфайлаў для распазнавання: wav фармат без кампрэсіі, 16000 Hz, 16-bit, mono. Хоць некаторыя модлі падтрымліваюць іншыя фарматы, яны могуць працаваць з імі некарэктна.
